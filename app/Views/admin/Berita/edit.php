...
<div class="row">
    <div class="card" style="border: none;">
        <ol class="breadcrumb">
            ...
            <li style="margin-right: 10px;" class="crumba"> > </li>
            <li style="margin-right: 10px;" class="crumba"> Edit Berita</li>
        </ol>
    </div>
    <div class="card">
        <form action="<?= base_url('/berita/update') ?>" method="post">
            <?= csrf_field() ?>
            <input type="text" name="id_ms_berita" required value="<?= $berita['id_ms_berita']; ?>" hidden>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="datetime-local" class="form-control" id="tgl_waktu" name="tgl_waktu" value="<?= $berita['tgl_waktu']; ?>">
            </div>
            <div class="mb-3">
